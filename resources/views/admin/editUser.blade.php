            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.editUser', $user->id) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="tel" class="form-control" name="phone" pattern="\d{3}[\-]\d{2}[\-]\d{6}\d?" placeholder="381-11-1234567 or 381-11-123456" value="{{ $user->phone }}" required>
